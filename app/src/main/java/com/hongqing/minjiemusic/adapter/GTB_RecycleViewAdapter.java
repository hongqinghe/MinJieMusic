...
public class GTB_RecycleViewAdapter extends RecyclerView.Adapter<GTB_RecycleViewAdapter.MyViewHolder>{
  private Context context;
    private List<NetMusic> mp3InfoList;
   private  OnItemClickListener onItemClickListener;
    public GTB_RecycleViewAdapter(Context context, List<NetMusic> mp3InfoList) {
